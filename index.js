...
app.post('/merge', upload.array('files', 100), (req, res) => {
  ...
  if (req.files) {
    ...
    exec(`magick convert ${list} -resize 1920x1080 -background black -gravity center -extent 1920x1080 -quality ${range_value} -page ${page_size} ${outputFilePath}`, (err, stdout, stderr) => {
      if (err) throw err
